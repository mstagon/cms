...
const aboutContent: Record<Language, AboutApiResponse> = {
  ko: {
    ...
    experiences: [
      {
        role: "멋쟁이 사자처럼 대학 11기 운영진",
        company: "멋쟁이 사자처럼 대학 11기 · 상명대학교",
        period: "2023.01 - 2023.12",
        description:
          "상명대학교 멋쟁이 사자처럼 대학 11기 운영진으로 활동하며 커리큘럼 운영과 팀 해커톤을 총괄했습니다. 웹 프로젝트 멘토링을 진행했습니다.",
        tags: ["Community", "Curriculum", "Mentoring"],
      },
      {
        role: "멋쟁이 사자처럼 대학 12기 운영진",
        company: "멋쟁이 사자처럼 대학 12기 · 상명대학교",
        period: "2024.01 - 2024.12",
        description:
          "상명대학교 멋쟁이 사자처럼 대학 12기 운영진으로 연임하여 교육 프로그램 고도화와 앱 프로젝트 멘토링을 담당했습니다. 운영진 온보딩 체계를 개선했습니다.",
